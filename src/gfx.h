...
int SCREEN_WIDTH2  (SCREEN_WIDTH >> 1);
int SCREEN_HEIGHT2 (SCREEN_HEIGHT >> 1);

int SCREEN_WIDEADD (SCREEN_WIDTH - 512);
int SCREEN_TALLADD (SCREEN_HEIGHT - 240);
int SCREEN_WIDEADD2 (SCREEN_WIDEADD >> 1);
int SCREEN_TALLADD2 (SCREEN_TALLADD >> 1);

int SCREEN_WIDEOADD (SCREEN_WIDEADD > 0 ? SCREEN_WIDEADD : 0);
int SCREEN_TALLOADD (SCREEN_TALLADD > 0 ? SCREEN_TALLADD : 0);
int SCREEN_WIDEOADD2 (SCREEN_WIDEOADD >> 1);
int SCREEN_TALLOADD2 (SCREEN_TALLOADD >> 1);
